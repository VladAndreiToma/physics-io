...
export default function SemiconductorsAdvanced(){
  ...
  - Semiconductors: Moderate band gap (\\( \\sim 0.6 - 3\\ \\text{eV} \\))
  - Effective mass approximation and density of states
  - Fermi level position determines carrier population
  `
    },
    {
      title: `Charge Carriers and Carrier Dynamics`,
      markdown: `
  Charge carriers in semiconductors are electrons and holes.
  
  - Drift: Motion due to applied electric field (\\( \\vec{v}_{\\text{drift}} = \\mu \\vec{E} \\))
  - Diffusion: Motion due to concentration gradients (\\( J = -D \\nabla n \\))
  - Mobility (\\( \\mu \\)): Measure of how easily carriers move
  ...
  - Continuity equation: \\( \\frac{\\partial n}{\\partial t} = G - R + \\nabla \\cdot (D \\nabla n) - \\nabla \\cdot (n \\mu \\vec{E}) \\)
  - Carrier lifetime (\\( \\tau \\)): Average time before recombination
  `
    },
    {
  ...
  - Carrier concentration \\( n = N_C e^{-(E_C - E_F)/kT} \\), \\( p = N_V e^{-(E_F - E_V)/kT} \\)
  `
    },
    {
      title: `PN Junctions and Diode Operation`,
      markdown: `
  When p-type and n-type materials are joined, a PN junction is formed.
  
  - Depletion region: Zone with immobile ionized dopants
  - Built-in potential \\( V_bi \\approx \\frac{kT}{q} \\ln\\left(\\frac{N_A N_D}{n_i^2}\\right) \\)
  ...
  - LEDs: Forward-biased PN junctions emit light via recombination (\\( E_{\\text{photon}} = h \\nu = E_g \\))
  ...
  - Quantum efficiency: \\( \\eta = \\frac{\\text{Number of carriers collected}}{\\text{Number of photons absorbed}} \\)
  - Responsivity \\( R = \\frac{I_{\\text{ph}}}{P_{\\text{opt}}} \\)
  `
    },
    {
      title: `Semiconductor Materials and Fabrication`,
      markdown: `
  ...
  - Scaling and Moore’s Law: \\( \\text{Number of transistors} \\propto 2^n \\)
  - Integration into complex ICs: Processors, memory, logic gates
  `
    },
    {
      title: `Quantum and Nano-scale Effects`,
      markdown: `
  ...
  - Ballistic transport and quantum conductance: \\( G = n \\cdot \\frac{2e^2}{h} \\)
  - Single-electron transistors and nanowires
  - Effects of defects, surface states, and dielectric breakdown
  `
    },
    {
      title: `Semiconductor Applications and Technologies`,
      markdown: `
